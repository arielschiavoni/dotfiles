...
local on_attach = function(client, bufnr)
  ...
  u.buf_map(bufnr, "n", "<space>D", "<cmd>lua vim.lsp.buf.type_definition()<CR>")
  ...
  u.buf_map(bufnr, "n", "<space>e", "<cmd>lua vim.diagnostic.open_float()<CR>")
  u.buf_map(bufnr, "n", "[d", "<cmd>lua vim.diagnostic.goto_prev()<CR>")
  u.buf_map(bufnr, "n", "]d", "<cmd>lua vim.diagnostic.goto_next()<CR>")
  u.buf_map(bufnr, "n", "<space>q", "<cmd>lua vim.diagnostic.setloclist()<CR>")
  u.buf_map(bufnr, "n", "<space>f", "<cmd>lua vim.lsp.buf.formatting()<CR>")
