...
vim.keymap.set("n", "<leader>d", ":put =strftime('%d/%m/%Y')<CR>", { desc = "insert current date" })
...
vim.keymap.set("n", "gdh", ":diffget //2<CR>", { desc = "resolve conflict using base diff buffer (//2 left" })
vim.keymap.set("n", "gdl", ":diffget //3<CR>", { desc = "resolve conflict using incoming diff buffer (//3 right)" })
