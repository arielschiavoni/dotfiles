  ...
  opts = {
    ...
    picker = {
      ...
      sources = {
        ...
        grep = files_picker_config,
        grep_buffers = files_picker_config,
        grep_word = files_picker_config,
        lsp_references = files_picker_config,
        lsp_symbols = files_picker_config,
      },
    },
